...
var sliced = foodList.slice(1, 3); //The beginning index, The end index(해당요소 미만)
console.log(sliced);
...
console.log(numsCopy); // [ 10, 20, 30, 40, 50 ]
...
console.log(concated); // [ 10, 20, 30, 99, 999 ]
...
console.log(foodList); // [ '닭꼬치', '볶음밥', '짜장면', '족발' ]
...
foodList.splice(2, 0, '마라탕'); // 2번 인덱스에 마라탕 삽입(삭제X)
console.log(foodList);

foodList.splice(2); // 2번부터 끝까지 싹 지우기
console.log(foodList); 