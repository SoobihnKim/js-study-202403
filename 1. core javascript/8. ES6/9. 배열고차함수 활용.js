...
/*
사과 중에 녹색이면서 당도가 9이상인 사과만 선별하여 // filtering
"이 사과는 oo색이며 당도는 ooo입니다" // mapping
...
userList
 ...
 .forEach(result => console.log(`${result.name}님의 두번쨰 취미는 ${result.second}입니다.`));
