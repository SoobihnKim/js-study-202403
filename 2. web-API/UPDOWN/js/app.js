...
function iconClickHandler (e) {
  if(!e.target.matches('#numbers .icon')) return;  // 흰 배경 클릭해도 안뜨게
  
  // 클릭한 구슬의 숫자를 정답과 비교해서 up, down, 정답인지 판별
