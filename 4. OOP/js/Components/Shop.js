...
class Shop {
  ...
  render() {
    ...
    const shoppingCart = new ShoppingCart('app');
    shoppingCart.render();

    new ProductList('app', [new Product('에어팟', 200000, '에어팟으로 노래를 들어요.', 'https://www.apple.com/v/airpods/v/images/overview/airpods_3rd_gen__dhy5bknhvtqq_large.jpg'), 
